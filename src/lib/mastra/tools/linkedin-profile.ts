...
// Schema matching the Apify API response structure
...
export const linkedInProfileTool = createTool({
  ...
  description:
    "Fetches LinkedIn profile data for one or more profile URLs. Extracts usernames from URLs and calls the Apify API to retrieve profile information.",
